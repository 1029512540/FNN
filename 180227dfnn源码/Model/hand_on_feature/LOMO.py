"""
==========================================================================
=third time to rewrite this file.                                        =
=                                                                        =
=                            What's new ?                                =
=                                                                        =
=the input:                                                              =
...
def LOMO_per(img,c_list=[5,20],low_clip=0.1,high_clip=0.9,
         R_list=[3,5],tau=0.3,hsv_bin_size=8,blocksize=32,block_step=16):
        
    xx,yy,zz=img.shape
    #print('the data is {0}*{1}*{2}'.format(xx,yy,zz))
...
def LOMO(imgs,num_of_img=2):

    feature=np.zeros((num_of_img,70770))
    #print(feature.shape)
    for i in range(num_of_img):
        feature[i,:]=LOMO_per(imgs[i,:,:,:])
